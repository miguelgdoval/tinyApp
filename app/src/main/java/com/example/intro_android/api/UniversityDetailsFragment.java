...
public class UniversityDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView nameText = view.findViewById(R.id.titleUniversityName);
        nameText.setText(university.getName());

        if (university.getAlphaTwoCode()!=null) {
            TextView alphaText = view.findViewById(R.id.universityAlphaTwoCode);
            alphaText.setText(android.text.TextUtils.concat("Country ISO: ",university.getAlphaTwoCode()));
        }

        if (university.getCountry()!=null) {
            TextView timeText = view.findViewById(R.id.universityCountry);
        ...
        if (university.getDomains()!=null && !university.getDomains().isEmpty()) {
            TextView domainText = view.findViewById(R.id.universityDomain);
            domainText.setText(android.text.TextUtils.concat("Domain: ",university.getDomains().get(0)));
        }

        if (university.getStateProvince()!=null) {
            TextView stateText = view.findViewById(R.id.universityStateProvince);
        ...
        if (university.getWebPages()!=null && !university.getWebPages().isEmpty()) {
            TextView webPageText = view.findViewById(R.id.universityWebPage);
